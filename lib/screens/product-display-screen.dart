...
import 'package:firstproject/widgets/product_display_list_view.dart';
import 'package:firstproject/widgets/top_container.dart';
...
class _ProductDisplayScreenState extends State<ProductDisplayScreen>
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          const TopContainer(title: 'Your Closet',
            ...
            tabs: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: selectedValue == 0? kBackgroundColor : kGreyColor.withOpacity(0.8),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    color: selectedValue == 1? kBackgroundColor : kGreyColor.withOpacity(0.8),
